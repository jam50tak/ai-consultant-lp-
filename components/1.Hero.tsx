      ...
      <div className="container mx-auto px-4 md:px-6 py-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="max-w-2xl mx-auto px-2">
            <div className="border-4 border-yellow-300 shadow-2xl bg-gradient-to-br from-red-600 via-orange-600 to-yellow-500 rounded-lg p-4 md:p-6 space-y-4 md:space-y-6">
              <div className="text-center space-y-3 md:space-y-4">
                <Badge className="text-sm md:text-base px-4 md:px-6 py-2 bg-white/20 backdrop-blur-sm text-white animate-pulse">
                  🔥 今だけ限定オファー 🔥
                </Badge>
                <h2 className="text-xl md:text-4xl font-black tracking-tight text-white drop-shadow-lg">
                  通常<span className="line-through text-white/70">¥4,980</span> →{' '}
                  <span className="text-yellow-300 block mt-2 text-4xl md:text-5xl">限定20名 無料</span>
                </h2>
              </div>
